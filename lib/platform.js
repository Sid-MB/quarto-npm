...
// Resolve the Quarto version from our own package version. We intentionally keep
// the npm package version identical to the Quarto version it distributes, so
// `npx @lillies/quarto@1.9.38` deterministically yields Quarto 1.9.38.
...
module.exports = { VENDOR_DIR, quartoVersion, resolveTarget };
